...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ObjectSpawner : MonoBehaviour
    {
        ...
        {
            // Check if prefab list is empty
            if (m_ObjectPrefabs == null || m_ObjectPrefabs.Count == 0)
            {
                Debug.LogError("ObjectSpawner: No prefabs available to spawn. Please add prefabs to the objectPrefabs list.");
                return false;
            }
            ...
            objectIndex = Mathf.Clamp(objectIndex, 0, m_ObjectPrefabs.Count - 1);
